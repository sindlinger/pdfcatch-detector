...
from pdfcatch.ia.ai_embed_covers import run as run_embed
from pdfcatch.ia.ai_paradigm_validate import run as run_paradigm
from pdfcatch.ia.catalog_store import (
    CATALOG_INDEX_PATH,
    catalog_dir_for_tag,
    normalize_tag,
    now_utc_iso,
